...
EXPORT X6_STATUS get_firmware_version(int, unsigned*, unsigned*);
...
//use pointer in `set_kernel_bias` for compatibility with Matlab because it doesn't support C99 
