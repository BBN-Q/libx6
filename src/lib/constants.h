...
#define WB_QDSP_THRESHOLD_INPUT_SEL(numRawKi,numDemod)    (WB_QDSP_THRESHOLD_INVERT(numRawKi,numDemod) + 1)
#define WB_QDSP_RAW_KERNEL_BIAS(numRawKi,numDemod)        (WB_QDSP_THRESHOLD_INPUT_SEL(numRawKi,numDemod) + 1)
